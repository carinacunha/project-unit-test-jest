...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    expect(Object.entries(getCharacter('Arya'))).toEqual(Object.entries(getCharacter('Arya')));
    // Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
    expect(Object.entries(getCharacter('Brienne'))).toEqual(Object.entries(getCharacter('Brienne')));
    // Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',
    expect(Object.entries(getCharacter('Melissandre'))).toEqual(Object.entries(getCharacter('Melissandre')));
    ...
    expect(getCharacter('Catarina')).toEqual(undefined);
  });
});
